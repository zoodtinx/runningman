      ...
      <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 ">
         <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
            ...
            <div className=" text-[40px]">
               <p className="font-light ">Text Texts</p>
               <p className="font-medium ">Text Texts</p>
               <p className="font-medium ">Text Texts</p>
               <p className="font-semibold ">Text Texts</p>
               <p className="font-bold ">Text Texts</p>
               <p className="font-bold headline ">Headline</p>
            </div>
            <div className=" font-headline text-[40px]">
