...
import { CheckCircle, NavArrowDown, NavArrowUp } from "iconoir-react";
   ...
   return (
      ...
      >
         ...
         <SelectPrimitive.Icon asChild className="">
            <TriangleDown className="size-2.5 text-secondary" />
   ...
   return (
      <SelectPrimitive.Portal>
         <SelectPrimitive.Content
            ...
            className={cn(
               "bg-background text-primary text-base p-[1px]",
...
function SelectLabel({
   ...
   return (
      <SelectPrimitive.Label
         ...
         className={cn("text-secondary px-2 py-1.5 text-base", className)}
         {...props}
      />
   );
}
