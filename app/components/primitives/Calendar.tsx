   ...
   return (
      <DayPicker
         ...
         classNames={{
            ...
            months: cn(
               "flex gap-4 flex-col md:flex-row relative text-primary",
            ...
            caption_label: cn(
               ...
               captionLayout === "label"
                  ? "text-base"
                  : "rounded-md pl-2 pr-1 flex items-center gap-1 text-base h-8 [&>svg]:text-background [&>svg]:size-3.5",
               defaultClassNames.caption_label
            ),
            table: "w-full border-transparent",
            weekdays: cn("flex text-md", defaultClassNames.weekdays),
            weekday: cn(
               "text-secondary rounded-md flex-1 font-normal select-none",
            ...
            week_number: cn(
               "text-[0.8rem] select-none text-secondary",
            ...
            today: cn(
               "bg-accent text-whie rounded-md data-[selected=true]:rounded-none",
   ...
   return (
      <Button
         ...
         className={cn([
            ...
            "[&>span]:text-xs",
            "[&>span]:opacity-70",
            defaultClassNames.day, // move into array
         ])}
         {...props}
      />
   );
