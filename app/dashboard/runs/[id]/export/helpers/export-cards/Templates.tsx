...
const MorningRun = React.forwardRef<HTMLDivElement, ExportCardProps>(
   ({ runData }, ref) => {
      ...
      return (
         <div
            ref={ref}
            className="flex flex-col gap-[55px] items-end w-fit h-fit text-[#ed1c24]"
         >
...
MorningRun.displayName = "MorningRun";

const Dopaminization = React.forwardRef<HTMLDivElement, ExportCardProps>(
   ({ runData }, ref) => {
      const { distance, duration } = runData;
      const pace = (duration / distance).toFixed(2);
      const fixedDuration = duration.toFixed(2);
      ...
      return (
         <div
            ref={ref}
            className="flex flex-col gap-[30px] items-center h-fit text-white w-fit"
         >
...
Dopaminization.displayName = "Dopaminization";

const FlowState = React.forwardRef<HTMLDivElement, ExportCardProps>(
   ({ runData }, ref) => {
      const { distance, duration } = runData;
      const pace = (duration / distance).toFixed(2);
      const fixedDuration = duration.toFixed(2);
      ...
      return (
         <div
            ref={ref}
            className="flex flex-col gap-[50px] items-center justify-between text-black w-[520px] h-[880px] bg-white pb-9"
         >
...
FlowState.displayName = "FlowState";

const FlyingSprint = React.forwardRef<HTMLDivElement, ExportCardProps>(
   ({ runData }, ref) => {
      const { distance, duration } = runData;
      const pace = (duration / distance).toFixed(2);
      const fixedDuration = duration.toFixed(2);
      ...
      return (
         <div ref={ref} className="w-[1000px] h-fit">
...
FlyingSprint.displayName = "FlyingSprint";

const Zone4 = React.forwardRef<HTMLDivElement, ExportCardProps>(
   ({ runData }, ref) => {
      const { distance, duration } = runData;
      const pace = (duration / distance).toFixed(2);
      const fixedDuration = duration.toFixed(2);
      ...
      return (
         <div ref={ref} className="flex flex-col items-end gap-5">
